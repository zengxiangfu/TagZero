...
- **滚动条支持**: 当画布放大超出视口时，自动显示水平和垂直滚动条，方便查看细节。
...
### 6. ⌨️ 快捷键自定义 (Custom Shortcuts)

- **可视化配置**: 点击顶部导航栏的齿轮图标，即可打开快捷键设置面板。
- **全键盘支持**: 支持自定义工具切换、编辑操作、视图控制等所有功能的快捷键。
- **组合键绑定**: 支持 Ctrl/Cmd、Shift、Alt 等修饰键的组合绑定。
- **一键恢复**: 支持对单个快捷键或所有快捷键进行一键恢复默认设置。

---

## ⌨️ 快捷键说明 (Shortcuts)

*(以下为默认快捷键，您可以在设置中进行修改)*
