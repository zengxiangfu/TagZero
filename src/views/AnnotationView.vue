          ...
          <div style="display: flex; gap: 8px; margin-left: 20px; align-items: center;">
            <div class="capsule-button-group">
              <n-tooltip trigger="hover">
                <template #trigger>
                  <n-button strong secondary @click="store.undo">
                    <template #icon>
                      <n-icon>
              ...
              <n-tooltip trigger="hover">
                <template #trigger>
                  <n-button strong secondary @click="store.redo">
                    <template #icon>
                      <n-icon>
            ...
            <div class="capsule-button-group">
              ...
              <n-tooltip trigger="hover">
                <template #trigger>
                  <n-button strong secondary @click="store.resetZoom">
                    <template #icon>
                      <n-icon>
...
// Listen for shortcut export event
onMounted(() => {
    window.addEventListener('shortcut-export', handleExport)
    window.addEventListener('shortcut-esc', () => {
        // Handle ESC key specific view logic if needed
    })
})

onUnmounted(() => {
    window.removeEventListener('shortcut-export', handleExport)
})
